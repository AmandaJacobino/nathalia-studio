      ...
      <footer className="w-full bg-gradient-to-r from-[#00c2cb] to-[#00c2cb] text-white">
        <div className="container mx-auto py-8 px-4 md:px-8 lg:px-16 xl:px-24">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="flex">
                ...
                <div>
                  <h3 className="[font-family:'Inter',sans-serif] font-medium text-base mb-1">
                    Horário de Atendimento
                  </h3>
                  <p className="[font-family:'Inter',sans-serif] font-normal text-sm">
                    Seg a Sex: 9h às 18h
                  </p>
                  <p className="[font-family:'Inter',sans-serif] font-normal text-sm">
                    Sábado: 9h às 15h
            ...
            <div className="space-y-8">
              ...
              <div className="flex">
                ...
                <p className="[font-family:'Inter',sans-serif] font-semibold text-base">
          ...
          <div className="flex items-center justify-center mt-10">
            ...
            <p className="[font-family:'Inter',sans-serif] font-normal text-xs opacity-70">
