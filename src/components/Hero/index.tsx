        ...
        <div className="w-full flex flex-col justify-center p-6 sm:p-8 lg:p-12">
            ...
            >
              <div className="relative">
                ...
                <div className={`absolute inset-0 flex justify-between items-center px-4 transition-opacity duration-300 ${isHovering ? 'opacity-100' : 'md:opacity-0 opacity-100'}`}>
                  ...
                  <button 
                    onClick={prevSlide}
                    className="bg-white bg-opacity-30 hover:bg-opacity-50 text-white rounded-full p-1 sm:p-2 transition-all duration-300"
          ...
          <div className="flex justify-center items-center gap-4 flex-wrap mb-8 sm:mb-10 lg:mb-12">
            ...
            <a 
             ...
             className="group bg-gradient-to-tr from-tiffany to-linearTiffany text-white font-medium py-2 sm:py-3 px-8 sm:px-10 rounded-full transition duration-300 text-sm sm:text-base border-2 border-transparent hover:from-white hover:to-white hover:text-tiffany hover:border-tiffany" 
             >
              Agendar atendimento
            </a>     
            ...
            <a 
              href="#servicos"
              className="bg-white text-tiffany font-medium py-2 sm:py-3 px-8 sm:px-10 rounded-full transition duration-300 text-sm sm:text-base border-2 border-tiffany hover:bg-gradient-to-tr hover:from-tiffany hover:to-linearTiffany hover:text-white hover:border-transparent">
              Conheça nossos serviços
            </a>
          </div>
        </div>
